    ...
    <script type="text/javascript">
        $(function () {
            ...
            /*$("button.addToCart").click(function () {
                ...
                var bookId = $(this).attr("bookId");
                location.href = "http://localhost:8081/book/cartServlet?action=addItem&id=" + bookId;
            });*/
        })
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            <c:if test="${empty sessionScope.cart.items}">
                ...
                <div><span id="cartBookName" style="color: red">当前购物车为空</span></div>
            </c:if>
