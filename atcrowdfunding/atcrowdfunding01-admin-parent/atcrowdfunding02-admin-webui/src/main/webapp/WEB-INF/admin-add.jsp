					...
					<div class="panel-body">
						<form action="admin/save.html" method="post" role="form">
							...
							<div class="form-group">
								<label for="adminAccount">登录账号</label>
								<input
									name="loginAcct"
									type="text" class="form-control" id="adminAccount"
									placeholder="请输入登录账号">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="adminUserName">用户昵称</label>
								<input
									name="userName"
							...
							<div class="form-group">
								<label for="adminUserEmail">邮箱地址</label>
								<input type="email"
									name="email"
									class="form-control" id="adminUserEmail"
									placeholder="请输入邮箱地址">
